...
<body>
	...
	<c:if test="${not empty userId}">
		<div class="mini-navbar" style="text-align: right;">
			...
			<a class="mini-item" onclick="return confirm('로그아웃 하시겠습니까?')" href="/logout">로그아웃</a>
		</div>
	</c:if>
	<!-- navbar -->
	<nav
	...
	<form action="/jobBoard/write" method="POST">
		<table class="table">
		...
		<input type="submit" onclick="alert('글이 등록되었습니다.')" class="btn btn-primary float-right" value="등록">		
	</form>
	</div>	
	<!-- footer -->
