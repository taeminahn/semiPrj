...
<body>
	...
	<form action="modify?p=${param.p}" method="POST">
		<table class="table">
			<thead class="thead-dark text-center">
				<tr>
					<input type="hidden" name="bbsNumSeq" value="${n.bbsNumSeq}">
					<td colspan="2"><input type="text" class="form-control"
						placeholder="글 제목" name="bbsTitle" value="${n.bbsTitle}" maxlength="50"></td>
				</tr>
			</thead>
			<tbody>
				<tr class="text-center">
					<td colspan="2"><textarea class="form-control"
						...
						style="height: 350px;">${n.bbsContent}</textarea></td>
				</tr>
			</tbody>
		</table> 
		<input type="submit" onclick="return confirm('정말로 수정하시겠습니까?')" class="btn btn-primary float-right" value="수정">	
	</form>
		<!-- <a href="hist"> --><%-- "boardDetail.kh?bbsNumSeq=${n.bbsNumSeq}" --%>
			<input type="submit"  class="btn btn-primary float-right"name="cancel" onclick="window.history.back()" value="취소">
		<!-- </a> -->
	</div>	
	<!-- footer -->
