...
public class BoardVO {
	...
	public BoardVO(int boardNum, int boardId, String boardTitle, String boardContent, Date boardPubDate, int boardHit,
	...
	public String toString() {
		return "BoardVO [boardNum=" + boardNum + "boardId=" + boardId + ", boardTitle=" + boardTitle + ", boardContent=" + boardContent
